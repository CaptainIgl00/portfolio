    ...
    <div class="container">
      <div class="footer-content">
        ...
        <div class="footer-social">
          <a href="https://github.com/captainigl00" target="_blank" class="social-link" title="GitHub">
          ...
          <a href="https://linkedin.com/in/mathéo-guilloux" target="_blank" class="social-link" title="LinkedIn">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div class="footer-bottom">
        <p class="copyright">© {{ currentYear }} Matheo Guilloux. Tous droits réservés.</p>
      </div>
    </div>
  </footer>
</template>
